...
public class About extends JFrame {
    ...
    About() {
        ...
        JLabel name = new JLabel("<html>Developed By:<br/>Chaitya Shah</html>");
        name.setBounds(20, 30, 550, 400);
        name.setFont(new Font("Tahoma", Font.PLAIN, 25));
        add(name);
        
        JLabel rollno = new JLabel("<html>SAP ID: <br/>60009210054</html>");
        rollno.setBounds(225, 30, 550, 400);
        rollno.setFont(new Font("Tahoma", Font.PLAIN, 25));
        add(rollno);
        
        JLabel contact = new JLabel("<html>Contact: <br/>chaityashah540@gmail.com</html>");
